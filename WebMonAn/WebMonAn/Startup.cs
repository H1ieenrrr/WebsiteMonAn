...
namespace WebMonAn
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IUpload, UploadHelper>();
            services.AddTransient<IMahoa, MaHoaHelper>();
            services.AddTransient<IFood, FoodSvc>();
            services.AddTransient<IUser, UserSvc>();

            services.AddTransient<ICart, CartSvc>();
            services.AddTransient<ICartDetails, CartDetailsSvc>();
        }
